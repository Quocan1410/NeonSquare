// NeonSquare/frontend/components/chat/ConversationsList.tsx
'use client';
...
export default function ConversationsList({
  ...
  const renderConversation = (conv: any) => {
    ...
    const avatarUrl: string | undefined = u.profilePicUrl ?? u.profilePic ?? undefined;
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between">
              <h4 className="font-medium text-forum-primary truncate">{displayName}</h4>
